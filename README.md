...
科研项目最常见的问题不是没有文档，而是文档太多、互相矛盾——同一个实验数字在三个文件里有三个版本，论文方法描述和实验记录对不上，session 结束时进度全靠记忆。

`research-docs-skill` 通过强制单一来源原则和标准化目录结构，让实验数字、方法描述、论文叙事各有唯一权威文件。无论是日常更新、session 交接还是 ARIS 归档，一条指令完成。
